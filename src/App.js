...
//         this.add.image(400, 300, 'background').setDisplaySize(800, 600).setOrigin(0.5);
...
//         <ul>
//           {data.map((item, index) => {
//             return <li key={index}>Admin Clicked  {item}</li>
//           })}
//         </ul>
//       </div>}
